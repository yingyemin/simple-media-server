var JSWebrtc = {
  ...
  JSWebrtc.Player = (function() {
      ...
      _self.pc
        ...
        .then(function(offer) {
          return new Promise(function(resolve, reject) {
            ...
            var api = _self.urlParams.user_query.play || "/api/v1/rtc/play";
            ...
            var data = {
              api: url,
              appName: _self.urlParams.app,
              streamName: _self.urlParams.stream,
    ...
    Player.prototype.stop = function(ev) {
        ...
        if (this.options.video && this.options.video.srcObject) {
            this.options.video.srcObject.getTracks().forEach(track => track.stop());
