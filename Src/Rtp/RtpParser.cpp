...
void RtpParser::parse(const char *data, size_t len)
{
    // 从配置中获取
...
void RtpParser::setOnRtpPacket(const function<void(const StreamBuffer::Ptr& buffer)>& cb)
{
    _onRtpPacket = cb;
}

void RtpParser::onRtpPacket(const StreamBuffer::Ptr& buffer)
{
