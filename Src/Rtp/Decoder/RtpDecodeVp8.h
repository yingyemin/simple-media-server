#ifndef RtpDecodeVp8_H
#define RtpDecodeVp8_H
...
class RtpDecodeVp8 : public RtpDecoder
{
public:
    using Ptr = std::shared_ptr<RtpDecodeVp8>;
    RtpDecodeVp8(const std::shared_ptr<TrackInfo>& trackInfo);
