#ifndef RtpDecodeVP9_H
#define RtpDecodeVP9_H
...
class RtpDecodeVP9 : public RtpDecoder
{
public:
    using Ptr = std::shared_ptr<RtpDecodeVP9>;
    RtpDecodeVP9(const std::shared_ptr<TrackInfo>& trackInfo);
